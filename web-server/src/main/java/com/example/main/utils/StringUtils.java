...
public class StringUtils{
     ...
     */
    public boolean isBlank(Object... objects) {
    ...
    public boolean isBlank(String... objects) {
        Object[] object = objects;
        return isBlank(object);
    }

    public boolean isNotBlank(String... objects) {
        Object[] object = objects;
        return !isBlank(object);
    }
     ...
     * @return
     */
    public int indexOf(String baseStr, String[] strings) {
     ...
     * @return
     */
    public JSONObject isJSONObject(String args) {
     ...
     * @return
     */
    public JSONArray isJSONArray(Object args) {
        ...
        if (args instanceof JSONArray) {
            ...
            JSONArray arr = (net.sf.json.JSONArray) args;
            for (Object json : arr) {
    ...
    public String trimToEmpty(Object str) {
...
//    }
     ...
     * @return
     */
    public String mapToGet(Map<? extends Object, ? extends Object> map) {
        String result = "";
     ...
     * @return
     */
    public Map<String, ? extends Object> getToMap(String args) {
        if (isBlank(args)) {
            return null;
        }
        args = args.trim();
     ...
     * @return
     */
    public String strToUrlcode(String value) {
        try {
     ...
     * @return
     */
    public String urlcodeToStr(String value) {
        try {
     ...
     * @return
     */
    public Boolean containsCN(String txt) {
        if (isBlank(txt)) {
            return false;
        }
     ...
     * @return
     */
    public String removeHtml(String news) {
     ...
     * @return
     */
    public List<String> array2Empty(String[] array) {
     ...
     * @return
     */
    public Set<?> array2Set(Object[] array) {
